        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    {{-- PERBAIKAN DI SINI --}}
                    <a href="{{ route('admin.tendik.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 mb-4">
                        + Tambah Tendik
                    </a>
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4">
                                    {{-- PERBAIKAN DI SINI --}}
                                    <a href="{{ route('admin.tendik.edit', $tendik->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                                    {{-- PERBAIKAN DI SINI --}}
                                    <form action="{{ route('admin.tendik.destroy', $tendik->id) }}" method="POST" class="inline" onsubmit="return confirm('Yakin hapus?');">
                                        @csrf @method('DELETE')
